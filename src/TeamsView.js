...
const TeamsView = () => {
    ...
    const saveSchedule = () => {
        ...
        fetch(`http://15.223.76.38:8080/league/${leagueID}/Division/${divisionID}/schedule`, {
            method: "PUT",
 ...
 const extractTableData = () => {
    ...
    const handleFileUpload = (e) => {
        ...
        reader.onload = (event) => {
            ...
            fetch(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/teams`, {
                method: "POST",
                headers: { "Content-type": "application/json" },
    ...
    const timeslotFileUpload = (e) => {
        ...
        reader.onload = (event) => {
            ...
            fetch(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/timeslots`, {
                method: "POST",
                headers: { "Content-type": "application/json" },
    ...
    useEffect(() => {
        fetch(`http://15.223.76.38:8080/leagues/${leagueID}/divisions/${divisionID}/teams`)
            .then((res) => res.json())
            .then((resp) => {
    ...
    useEffect(() => {
        fetch(`http://15.223.76.38:8080/leagues/${leagueID}/divisions/${divisionID}/timeslots`)
            .then((res) => res.json())
            .then((resp) => {
    ...
    useEffect(() => {
        fetch(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/schedules`)
            .then((res) => res.json())
            .then((resp) => {
    ...
    const RemoveTeam = (leagueID, divisionID, teamID, teamName) => {
        if (window.confirm("Do you want to delete " + teamName + "?")) {
            fetch(`http://15.223.76.38:8080/leagues/${leagueID}/divisions/${divisionID}/teams/${teamID}`, {
                method: "DELETE",
            }).then((res) => {
    ...
    const fetchLeagues = async () => {
        ...
        const updatedTeams = await Promise.all(teams.map(async (team) => {
            ...
            const response = await fetch(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/team/${team.id}/weight`);
        ...
        await fetch(`http://15.223.76.38:8080/league/${leagueID}/Division/${divisionID}/teams`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
        ...
        console.log(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/schedule?freezeWeeks=${selectedWeeks}`);
        fetch(`http://15.223.76.38:8080/league/${leagueID}/division/${divisionID}/schedule?freezeWeeks=${selectedWeeks}`)
            .then((res) => res.json())
            .then((resp) => {
